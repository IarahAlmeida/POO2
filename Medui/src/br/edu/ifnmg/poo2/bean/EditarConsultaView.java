...
@Named
@ViewScoped
public class EditarConsultaView implements Serializable{
    ...
    public void carregarEdicao() {
		try {
			consulta = consultService.buscar(codigo);
			selectedPatient = consulta.getPatient();
			selectedDoctor = consulta.getDoctor();
			dataConsulta = consulta.getDate_time();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void atualizarConsulta() {
		try {
			if(selectedPatient == null) {
				...
				JSFUtil.adicionarMensagemSucesso("Consulta Atualizada");
			}
		} catch (Exception e) {
			e.printStackTrace();
			JSFUtil.adicionarMensagemErro(e.getMessage());
